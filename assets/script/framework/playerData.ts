...
export class PlayerData {
    ...
    public revivalCount: number = 0;        //复活次数
    ...
    public gameOver(score: number) {
        this.score = score
        if (score > this.playerInfo[Constant.PLAYER_BEST_SCORE]) {
            this.playerInfo[Constant.PLAYER_BEST_SCORE] = score;
            this.savePlayerInfoToLocalCache();
            return true;
        }
        return false;
